 ...
 * @enum {string}
 */
export type AssetStorageEncryptionFormat =
  | "None"
 ...
 * @enum {string}
 */
export type ContentKeyPolicyPlayReadyLicenseType =
  | "Unknown"
  | "NonPersistent"
  | "Persistent";
 ...
 * @enum {string}
 */
export type StreamingPolicyStreamingProtocol =
  | "Hls"
  | "Dash"
  | "SmoothStreaming"
  | "Download";
